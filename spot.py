...
class SPOT:
    ...
    def _grimshaw(self, epsilon=1e-8, n_points=10):
        ...
        left_zeros = SPOT._rootsFinder(lambda t: w(self.peaks, t),
                                       ...
                                       (a + epsilon, -epsilon),
                                       n_points, 'random')     #'random' 'regular'
...
class bidSPOT:
    ...
    def initialize(self, level=0.1, verbose=False):
        """
        Run the calibration (initialization) step
        ...
        self.init_threshold['up'] = S[int((1-level) * n_init)]  # t is fixed for the whole algorithm
        self.init_threshold['down'] = S[int(level * n_init)]  # t is fixed for the whole algorithm
